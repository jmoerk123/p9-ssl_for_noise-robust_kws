...
# # Fine-tuning
python projects/p9-ssl_for_noise-robust_kws/data2vec-KWS-main/train.py --conf projects/p9-ssl_for_noise-robust_kws/data2vec-KWS-main/KWT_configs/noise/kwt1_finetune_mean_config_snr-5.yaml --ckpt data/runs/kwt1_data2vec_pre_nonoise/best.pth
python projects/p9-ssl_for_noise-robust_kws/data2vec-KWS-main/train.py --conf projects/p9-ssl_for_noise-robust_kws/data2vec-KWS-main/KWT_configs/noise/kwt2_finetune_mean_config_snr-5.yaml --ckpt data/runs/kwt2_data2vec_pre_nonoise/best.pth
python projects/p9-ssl_for_noise-robust_kws/data2vec-KWS-main/train.py --conf projects/p9-ssl_for_noise-robust_kws/data2vec-KWS-main/KWT_configs/noise/kwt3_finetune_mean_config_snr-5.yaml --ckpt data/runs/kwt3_data2vec_pre_nonoise/best.pth
