...
python projects/p9-ssl_for_noise-robust_kws/data2vec-KWS-main/train.py --conf projects/p9-ssl_for_noise-robust_kws/data2vec-KWS-main/KWT_configs/multidata/kwt1_finetune_mean_config_multidata.yaml --ckpt data/runs/kwt2_data2vec_multidata/best_encoder.pth
python projects/p9-ssl_for_noise-robust_kws/data2vec-KWS-main/train.py --conf projects/p9-ssl_for_noise-robust_kws/data2vec-KWS-main/KWT_configs/multidata/kwt1_finetune_mean_config_multidata.yaml --ckpt data/runs/kwt3_data2vec_multidata/best_encoder.pth
